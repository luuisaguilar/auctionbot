...
TELEGRAM_TOKEN  = "8771504523:AAEvpnWfrZNECwzoKOPdicOvyDgzH_upU8k"
TELEGRAM_CHAT_ID = "6021267163"   # <-- pega aquí tu chat_id cuando lo tengas
...
async def run(max_minutes: int, dry_run: bool):
    ...
    if not TELEGRAM_CHAT_ID and not dry_run:
        print(f"\n  ⚠️  TELEGRAM_CHAT_ID está vacío. Configúralo en el script.")
